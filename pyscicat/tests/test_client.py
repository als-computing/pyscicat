...
def add_mock_requests(mock_request):
    mock_request.post("http://localhost:3000/api/v3/Users/login", json={"id": "a_token"}, )
    ...
    mock_request.post("http://localhost:3000/api/v3/RawDatasets/42/attachments", json={"response": "random"})
